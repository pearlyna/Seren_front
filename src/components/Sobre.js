    ...
    <section className="right_caixa">
        ...
        <p className="p">
            <span className="span1">
                ...
                A propriedade oferece acomodações confortáveis com uma<br />
                combinação de estilo moderno, cercada por jardins tranquilos e <br />
    ...
    <section className="left_caixa">
        ...
        <p className="p">
            <span className="span3">
                A minha missão é tornar cada estadia única e especial. <br />
                Acredito que pequenos detalhes fazem uma grande diferença, e <br />
                me esforço para oferecer o melhor em conforto e hospitalidade.
            </span>
            <span className="span4">
                Localizado em uma região rica em belezas naturais, o Serenvilar é <br />
                o destino ideal para quem busca uma pausa na rotina. Com <br />
                hospitalidade acolhedora e experiências únicas, garantimos uma <br />
